...
//             <Route path="/admin/orderlist" component={OrderListScreen} exact />
//             <Route path="/products" component={AllProductsScreen} exact />
//             <Route path="/products/page/:pageNumber/:filter" component={AllProductsScreen} exact />
//             <Route path="/products/search/:keyword/:filter" component={AllProductsScreen} exact />
//             <Route path="/products/search/:keyword/page/:pageNumber/:filter" component={AllProductsScreen} exact />
//           </Switch>
//         </Container>
//       </main>
//       <Footer />
